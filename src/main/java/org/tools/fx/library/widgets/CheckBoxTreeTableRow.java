package org.tools.fx.library.widgets;
...
//        TreeTableRowSkin<T>  rowSkin = new TreeTableRowSkin<T>(this) {
//        };
         
    }

    private static class CheckBoxTreeTableRowSkin<S> extends TreeTableRowSkin<S> {
